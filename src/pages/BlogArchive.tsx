  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <div className="bg-gradient-to-b from-spirit-50 to-white py-12 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            <h1 className="text-4xl md:text-5xl font-serif font-semibold mb-6">
              Article Archive
            </h1>
            <p className="text-xl text-earth-700 max-w-2xl mx-auto">
              Explore our complete collection of articles on spiritual growth and personal development.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
              ...
              <Card key={post.id} className="overflow-hidden">
                <div className="md:flex">
                  ...
                  <CardContent className="md:w-2/3 p-6">
                    <div className="flex items-center gap-2 text-sm text-spirit-600 mb-2">
                    ...
                    <div className="text-earth-700 mb-4">
                      ...
                      <Link 
                        to={`/blog/${post.id}`} 
                        className="text-spirit-600 hover:text-spirit-800 font-medium inline-flex items-center"
                      >
                        Continue reading
                    ...
                    <div className="mt-4 flex justify-between items-center">
                      <span className="text-sm text-earth-600">By {post.author}</span>
          ...
          <Pagination className="mt-10">
            <PaginationContent>
              ...
              <PaginationItem>
                <PaginationNext 
                  onClick={() => setCurrentPage(prev => Math.min(prev + 1, Math.ceil(allPosts.length / postsPerPage)))}
                  className={currentPage === Math.ceil(allPosts.length / postsPerPage) ? 'pointer-events-none opacity-50' : ''}
                />
              </PaginationItem>
            </PaginationContent>
          </Pagination>
